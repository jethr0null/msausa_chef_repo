...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "msausa-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/msausa"
  #   chef.validation_client_name = "msausa-validator"
  #   chef.validation_key_path = ".chef/msausa-validator.pem"
  # end
end
